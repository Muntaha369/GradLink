    ...
    return (
        <div className="bg-gray-100 min-h-screen" style={{ fontFamily: "'Inter', sans-serif" }}>
          ...
          {editInfo &&(
            ...
            <div className='CloseButtonContainer animate-fade-in-scale '>
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">Edit Information</h2>
                    <button onClick={()=>setEditInfo(false)} className="text-gray-400 hover:text-gray-600">
