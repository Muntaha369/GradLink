...
const SpecificU = () => {
    ...
    useEffect(() => {
        const GetUser = async () => {
            try {
                const res = await axios.post('http://localhost:3000/api/FindIndie', { Uname: multiUname });
        ...
        GetUser();
    }, [multiUname]); // Added multiUname to the dependency array
                        ...
                        <div className="absolute top-0 left-6 -translate-y-1/2">
                            {user.Uname && (
                                <img
                                    ...
                                    src={user.avatarUrl} // Use the correct avatarUrl from the user object
                                    alt="User avatar"
                                />
                            )}
                        </div>
